...
function App() {
  ...
  const MenuList =  [
    ...
    },
    {
      ...
      neighborhood: "Brooklyn",
      photograph: "https://images.unsplash.com/photo-1520201163981-8cc95007dd2a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1534&q=80",
    ...
    },
    {
      ...
      name: "Hometown BBQ",
      neighborhood: "Brooklyn",
      photograph: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1534&q=80",
    ...
    <div>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/products" element={<Products MenuList={MenuList} />} />
          <Route path="/products/:id" element={<SingleProduct MenuList={MenuList} />} />
